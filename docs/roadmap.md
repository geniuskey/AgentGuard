...
| CC 설정 확장 Phase 1 (2026-07-18) | ✅ 완료 | `/user` 일반 설정 폼(모델·동작·Git·권한 고급·env)·settings lint·secret 감지. Phase 2~3와 백로그는 [claude-code-settings-plan.md](claude-code-settings-plan.md) |
